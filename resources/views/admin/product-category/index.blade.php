        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <table id="tab-admin" class="table no-margin table-bordered table-hover">
                    ...
                    <tr>
                        <th>ID</th>
                        <th>{{ __('clara-pim::product-category-text.name_product_category') }}</th>                        
                        <th></th>
                        <th></th>
                    </tr>
                    </thead>
            ...
            <div class="box-footer clearfix">
                {!! Button::info('Ajouter')->asLinkTo(route('admin.product-category.create'))->small() !!}
            </div>
            <!-- /.box-footer -->
        </div>
        <!-- /.box -->
    ...
    <script>
        $(document).ready(function() {
            $('#tab-admin').DataTable({
                serverSide: true,
                ajax: {
                    'url': '{{ route('api.admin.product-category.index') }}',
                    headers: {
                ...
                columns: [
                    { 'data': 'id_product_category' },
                    {
                        ...
                        name: "product_category_trans.name_product_category"
                    },
                    {
                        "data": "id_product_category",
                        "render": function ( data, type, row, meta ) {

                            var render = "{!! Button::warning('Modifier')->asLinkTo(route('admin.product-category.edit', 'dummyId'))->extraSmall()->block()->render() !!}";
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = '{!! BootForm::open()->action( route("admin.product-category.destroy", "dummyId") )->product("onsubmit", "return confirm(\'Vraiment supprimer cet objet ?\')")->delete() !!}'
