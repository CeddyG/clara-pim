    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="box box-info">	
                ...
                <div class="box-body"> 
                    @if(isset($oItem))
                        @php $oItem->attribute_category_text = $oItem->attribute_category_text->keyBy('fk_lang')->toArray() @endphp

                        {!! BootForm::open()->action(route('admin.attribute-category.update', $oItem->id_attribute_category))->put() !!}
                        {!! BootForm::bind($oItem) !!}
                    @else
